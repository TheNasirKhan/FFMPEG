...
- (NSString*)getAudioSamplePath {
    ...
    if ([fileManager fileExistsAtPath:[docFolder stringByAppendingPathComponent: @"audio-sample.wav"]]){
        
        NSURL *soundFileURL = [NSURL fileURLWithPath:[docFolder stringByAppendingPathComponent: @"audio-sample.wav"]];
...
//    if ([fileManager fileExistsAtPath:[docFolder stringByAppendingPathComponent: @"audio.mp3"]]){
//        NSURL *soundFileURL = [NSURL fileURLWithPath:[docFolder stringByAppendingPathComponent: @"audio.mp3"]];
//
...
//    }
    ...
    if ([fileManager fileExistsAtPath:[docFolder stringByAppendingPathComponent: @"audio.opus"]]){
        return [docFolder stringByAppendingPathComponent: @"audio.opus"];
    }
